...
public class Game {
    ...
    private static boolean checkWin(int c, int r) {
        ...
        if (upleft && downright) {
            if (current.getDownright().getDownright() != null) {
                if (current.getDownright().getDownright().getValue() == current.getValue()) {
                    return true;
                }
            }
            if (current.getUpleft().getUpleft() != null) {
                if (current.getUpleft().getUpleft().getValue() == current.getValue()) {
                    return true;
                }
            }
        }
        ...
        if (upleft) {
            if (current.getUpleft().getUpleft() != null) {
                if (current.getUpleft().getUpleft().getUpleft() != null 
                        && current.getUpleft().getUpleft().getValue() == current.getValue()) {
                    if (current.getUpleft().getUpleft().getUpleft().getValue() == current.getValue()) {
                        return true;
                    }
                }
            }
        ...
        if (downright) {
            if (current.getDownright().getDownright() != null) {
                if (current.getDownright().getDownright().getDownright() != null 
                        && current.getDownright().getDownright().getValue() == current.getValue()) {
                    if (current.getDownright().getDownright().getDownright().getValue() == current.getValue()) {
                        return true;
                    }
                }
            }
        ...
        if (downleft && upright) {
            System.out.println(current.getUpright().getUpright().getValue());
            if (current.getUpright().getUpright() != null) {
                if (current.getUpright().getUpright().getValue() == current.getValue()) {
                    return true;
                }
            }
            if (current.getDownleft().getDownleft() != null) {
                if (current.getDownleft().getDownleft().getValue() == current.getValue()) {
                    return true;
                }
            }
        }
        ...
        if (downleft) {
            if (current.getDownleft().getDownleft() != null) {
                if (current.getDownleft().getDownleft().getDownleft() != null 
                        && current.getDownleft().getDownleft().getValue() == current.getValue()) {
                    if (current.getDownleft().getDownleft().getDownleft().getValue() == current.getValue()) {
                        return true;
                    }
                }
            }
        ...
        if (upright) {
            if (current.getUpright().getUpright() != null) {
                if (current.getUpright().getUpright().getUpright() != null 
                        && current.getUpright().getUpright().getValue() == current.getValue()) {
                    if (current.getUpright().getUpright().getUpright().getValue() == current.getValue()) {
                        return true;
                    }
                }
            }
